            ...
            <div class="w-full">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Trip Plan') }}</h1>
                        <p class="mt-2 text-sm text-gray-700">A list of all the {{ __('Trip Plan') }}.</p>
                    </div>
